...
<?php
		...
		else
		{
			...
			$insert_sql="INSERT INTO food(dy_name,dy_in,dy,dy_w) VALUES (?,?,?,?)";
	
			$result=$sqlconn->prepare($insert_sql);
	
	
	
			$result->bind_param('ssss',$dy_name,$dy_in,$dy,$dy_w);
			...
			echo "<script language='javascript'> alert('添加成功');	window.history.back();location.href=\"./dynamic_show.php\";</script>";
		}
...
<form action="dynamic_insert.php" name="add_dynamic_form"  method="post" >
<div class="MainDiv">
